	...
	$.fn.imageuploadify = function(opts) {
		...
		this.each(function() {
			...
			const disableMouseEvents = () => {
				...
				dragbox.css("border-color", "##0e0e18");
			...
			button.mouseenter(function onMouseEnter(event) {
				button.css("background", "#0e0e18").css("color", "white");
			}).mouseleave(function onMouseLeave() {
				button.css("background", "white").css("color", "#0e0e18");
			});
